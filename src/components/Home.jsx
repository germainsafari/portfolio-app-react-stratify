...
const Home = () => {
  return (
    <div name='home' className='w-full min-h-screen bg-[#0a192f] pt-[90px] pb-16'>
      {/* Container */}
      <div className='w-full max-w-[1000px] mx-auto px-0 sm:px-8 flex flex-col justify-center min-h-screen'>
        <div className='space-y-6'>
          <h1 className='text-3xl sm:text-7xl font-bold text-[#ccd6f6] leading-tight'>
            Stratify AI Co.
          </h1>
          <h2 className='text-xl sm:text-5xl font-bold text-[#8892b0] leading-snug'>
            Transforming Businesses Through AI
          </h2>
          <p className='text-[#8892b0] py-4 max-w-[700px] text-base sm:text-lg'>
